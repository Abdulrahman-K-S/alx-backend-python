# <p align='center'>0x00. Python - Variable Annotations</p>
...
- [Mandatory tasks](#mandatory)
    - [0. Basic annotations - add](#0-basic-annotations---add)
    - [1. Basic annotations - concat](#1-basic-annotations---concat)
    - [2. Basic annotations - floor](#2-basic-annotations---floor)
    - [3. Basic annotations - to string](#3-basic-annotations---to-string)
    - [4. Define variables](#4-define-variables)
    - [5. Complex types - list of floats](#5-complex-types---list-of-floats)
    - [6. Complex types - mixed list](#6-complex-types---mixed-list)
    - [7. Complex types - string and int/float to tuple](#7-complex-types---string-and-intfloat-to-tuple)
    - [8-make_multiplier.py](#8-make_multiplierpy)
    - [9. Let's duck type an iterable object](#9-lets-duck-type-an-iterable-object)
- [Advanced Tasks](#advanced)
    - [10. Duck typing - first element of a sequence](#10-duck-typing---first-element-of-a-sequence)
    - [11. More involved type annotations](#11-more-involved-type-annotations)
